# -*- coding: utf-8 -*-
"""
逐帧 OCR 定位含 AI/生成 的文字框 -> 仅对该文字像素 inpaint 去除（背景零误伤）。
用法见 SKILL.md 阶段 2。依赖: opencv-python, numpy, rapidocr-onnxruntime
"""
import cv2, numpy as np, argparse, time
from rapidocr_onnxruntime import RapidOCR

# 需清除的关键词（抖音 AI 内容角标常见形态）
KEYWORDS = ("AI", "生成", "A1", "A I", "A.I", "A｜", "AI生成")
...
def main():
    ...
    # 限定搜索区可提速: --region y0 y1 x0 x1 (原帧坐标)
